...
import morn91.com.github.pan_tilt_control.R;
import morn91.com.github.pan_tilt_control.TimePicker.OnTimeChangedListener;
...
public class MyTimePickerDialog extends AlertDialog implements OnClickListener, 
    ...
    public MyTimePickerDialog(Context context,
            ...
            int hourOfDay, int minute, int seconds, boolean is24HourView, int mode) {
    	
        this(context, 0,
                callBack, hourOfDay, minute, seconds, is24HourView, mode);
    }
    ...
    private void updateTitle(int hour, int minute, int seconds) {
        ...
        switch (mInitialMode) {
            case 0:
                setTitle(R.string.time_set_0);
                break;
            case 1:
                setTitle(R.string.time_set_1);
                break;
            case 2:
                setTitle(R.string.time_set_2);
                break;
        }
    }
